...
& $env:BLENDER_EXE --background --python $forge -- --manifest $manifest --faction black --piece all --source-root $env:TUMBO_CHESS_SOURCE_ROOT --output-root $out --private-review-root $private --face-image $env:TUMBO_FACE_IMAGE
